...
function VideoHeroSection() {
  ...
  useEffect(() => {
    ...
    // Retry when video becomes visible (catches lazy-load / scroll cases)
    ...
    // Retry on first user interaction (browser unlocks autoplay after click/tap)
    const unlock = () => {
      tryPlay();
...
// ── Main Page ─────────────────────────────────────────────────────────────────
export default function Variation6Client() {
          ...
          >
            ...
            <Container>
              <div className="mx-auto max-w-4xl">
                ...
                <h2
                  className="font-sans font-semibold leading-tight tracking-tight text-2xl md:text-3xl text-center"
                  style={{ color: INK }}
                >
                  Research first.
                </h2>
                <p
                  className="mx-auto mt-6 max-w-2xl font-sans text-base leading-relaxed text-center"
                  style={{ color: INK }}
                >
        ...
        <SectionReveal amount={0.07}>
          ...
          >
            <Container>
              ...
              <h2
                className="font-sans font-semibold leading-tight tracking-tight text-2xl md:text-3xl"
                style={{ color: INK }}
              >
                Multiple members, one standard.
              </h2>
              <p
                className="mt-3 max-w-2xl font-sans text-sm leading-relaxed"
                style={{ color: MUTED }}
              >
                    ...
                    <StaggerItem key={member.handle} className="h-full">
                      <article className="relative flex h-full flex-col overflow-hidden border border-[#d8d8d8] bg-white shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
                        ...
                        <div className="relative flex flex-1 flex-col px-7 pb-7 pt-6">
                          ...
                          <p className="mt-3 flex-1 font-sans text-sm leading-relaxed text-[#111111]">
                            {member.blurb}
                          </p>
                          <a
                            href={member.xUrl}
